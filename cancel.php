...
$sql = "DELETE FROM user_bookings WHERE t_num = '$ticket_number' AND date='$date' AND passengername = '$passenger_name' AND train_name='$train_name' AND Age='$age' AND status='$status';";
